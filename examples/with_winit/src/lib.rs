    ...
    fn window_event(
        ...
        match event {
                ...
                if event.state == ElementState::Pressed {
                    match event.logical_key.as_ref() {
                        ...
                        Key::Character(char) => {
                            ...
                            // see e.g. https://xi.zulipchat.com/#narrow/channel/351333-glazier/topic/Keyboard.20shortcuts
            ...
            WindowEvent::RedrawRequested => {
                ...
                // [#vello > async on wasm](https://xi.zulipchat.com/#narrow/channel/197075-vello/topic/async.20on.20wasm)
                #[expect(
                    deprecated,
