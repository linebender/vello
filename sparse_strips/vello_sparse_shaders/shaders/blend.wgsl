...
fn fs_main(
    ...
    if (has_alpha) != 0u {
        ...
        switch channel_index {
            case 1u: { column = packed.y; }
            case 2u: { column = packed.z; }
            case 3u: { column = packed.w; }
            default: {}
        }
