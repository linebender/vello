...
impl FilterLayerPlacement {
    /// An empty [`FilterLayerPlacement`] instance.
    ...
    /// Create a new [`FilterLayerPlacement`] instance.
    pub fn new(bbox: RectU16, filter_plan: &FilterData) -> Self {
    ...
    /// Return the origin of the filter layer.
    pub fn src_origin(self) -> (u16, u16) {
        (self.src_x, self.src_y)
    }
}

/// Precomputed data for a filter.
#[derive(Debug, Clone)]
