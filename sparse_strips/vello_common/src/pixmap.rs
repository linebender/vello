...
impl Pixmap {
    ...
    /// Convert a [`peniko::ImageData`] to an [`Pixmap`].
    ///
    /// This is a potentially lossy conversion, as the image data data is transformed to
    ...
    pub fn from_peniko_image_data(image: &peniko::ImageData) -> Self {
        ...
        let pixels = image
            ...
            .collect();
        Self::from_parts(pixels, width, height)
    }
}
