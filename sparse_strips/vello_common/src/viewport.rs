...
//! Viewport state storing information about clip state and active strip generators.
...
impl ViewportState {
    /// Create a new viewport state for the given viewport.
    ...
    /// Width of the active strip generation viewport.
    pub fn width(&self) -> u16 {
        self.strip_generator.width()
    }

    /// Height of the active strip generation viewport.
    ...
    /// Whether any filter surfaces are currently pushed.
    pub fn has_filter_surfaces(&self) -> bool {
    ...
    pub fn push_filter_surface(&mut self, filter_data: &FilterData) {
    ...
    /// Pop the last filter surface.
    pub fn pop_filter_surface(&mut self) {
