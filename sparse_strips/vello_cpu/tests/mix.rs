...
macro_rules! mix {
    ($name:expr, $blend_mode:expr) => {
        // TODO: Re-add once images have been merged
        ...
        // 
        // let image = Image {
        //     pixmap: Arc::new(Pixmap::from_png(&std::fs::read("/Users/lstampfl/Programming/GitHub/vello/sparse_strips/vello_cpu/typst.png").unwrap()).unwrap()),
        //     x_extend: Extend::Pad,
        //     y_extend: Extend::Pad,
