...
pub struct RenderContext {
    ...
    #[cfg(feature = "text")]
    pub(crate) glyph_caches: Option<crate::text::CpuGlyphCaches>,
    #[cfg(feature = "text")]
...
impl RenderContext {
    ...
    pub fn new_with(width: u16, height: u16, settings: RenderSettings) -> Self {
        ...
        Self {
            ...
            filter: None,
            #[cfg(feature = "text")]
            glyph_caches: Some(crate::text::CpuGlyphCaches::default()),
            #[cfg(feature = "text")]
    ...
    pub fn glyph_run(
        ...
        crate::text::GlyphRunBuilder {
            inner: parley_draw::GlyphRunBuilder::new(font.clone(), self.state.transform),
            ctx: self,
        }
    }
