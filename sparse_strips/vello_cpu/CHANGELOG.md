...
- Added `render_to_pixmap_at_offset` method to `RenderContext` for rendering at specific offsets within a larger pixmap, enabling spritesheet/texture atlas support. ([#1416][] by [@grebmeg][])
