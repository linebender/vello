...
mod tests {
    ...
    fn external_texture_composite(ctx: &mut impl Renderer) {
        ...
        fill_sprite_rect(ctx, texture_id, SPRITES[0], 12., 15., ImageQuality::Low);
    ...
    fn external_texture_opaque_interleaving(ctx: &mut impl Renderer) {
        ...
        fill_texture_rect(ctx, texture_id, 28., 28., 40., 40., true);
    ...
    fn external_texture_runs_with_opaque_prefix(ctx: &mut impl Renderer) {
        ...
        fill_texture_rect(ctx, red_texture, 8., 8., 40., 40., true);

        ctx.set_paint(AlphaColor::from_rgba8(255, 255, 255, 128));
        ctx.fill_rect(&Rect::new(24., 24., 72., 72.));

        fill_texture_rect(ctx, green_texture, 28., 28., 40., 40., true);
    ...
    fn external_texture_root_painter_order(ctx: &mut impl Renderer) {
        ...
        fill_texture_rect(ctx, coral, 6., 6., 88., 88., false);
        fill_texture_rect(ctx, gold, 11.5, 33.5, 77., 33., true);
        fill_texture_rect(ctx, gold, 33.5, 11.5, 33., 77., true);
        fill_texture_rect(ctx, teal, 21.5, 21.5, 57., 57., false);
        ctx.set_tint(Some(Tint {
            color: Color::from_rgba8(128, 102, 204, 160),
            mode: TintMode::Multiply,
        }));
        fill_texture_rect(ctx, tint_source, 16., 38., 68., 24., false);
        fill_texture_rect(ctx, tint_source, 38., 16., 24., 68., false);
        ctx.set_tint(None);
        fill_texture_rect(ctx, navy, 33.5, 33.5, 33., 33., false);
        fill_texture_rect(ctx, gold, 28., 44., 44., 12., true);
        fill_texture_rect(ctx, gold, 44., 28., 12., 44., true);
    ...
    fn external_texture_atlas_interleaving(ctx: &mut impl Renderer) {
        ...
        fill_texture_rect(ctx, external_green, 66., 10., 24., 24., true);
        draw_atlas_rect(ctx, atlas_blue, Rect::new(38., 38., 62., 62.));
        fill_texture_rect(ctx, external_yellow, 10., 66., 24., 24., true);
    ...
    fn external_texture_layer_before_external(ctx: &mut impl Renderer) {
        ...
        ctx.push_layer(None, None, None, None, None);
        fill_texture_rect(ctx, texture_id, 40., 40., 40., 40., true);
        ctx.pop_layer();
    }
    ...
    fn external_texture_external_before_layer(ctx: &mut impl Renderer) {
        ...
        ctx.push_layer(None, None, None, None, None);
        fill_texture_rect(ctx, texture_id, 20., 20., 40., 40., true);
        ctx.pop_layer();
    ...
    fn external_texture_clipped(ctx: &mut impl Renderer) {
        ...
        fill_sprite_rect(ctx, texture_id, SPRITES[1], 18., 18., ImageQuality::Medium);
        ctx.set_paint_transform(Affine::translate((34., 34.)));
        fill_sprite_rect(ctx, texture_id, SPRITES[3], 34., 34., ImageQuality::Medium);
        ctx.pop_layer();
    }
    ...
    fn external_texture_blurred(ctx: &mut impl Renderer) {
        ...
        fill_sprite_rect(ctx, texture_id, SPRITES[2], 20., 20., ImageQuality::Low);
        ctx.pop_layer();
    }
    ...
    fn external_texture_many_sprites(ctx: &mut impl Renderer) {
        ...
        for (source_region, x, y) in placements {
            ...
            fill_sprite_rect(ctx, texture_id, source_region, x, y, ImageQuality::Low);
        }
    }
